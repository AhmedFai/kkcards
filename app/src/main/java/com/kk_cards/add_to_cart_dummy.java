...
public class add_to_cart_dummy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("rowsssss", String.valueOf(count));
...
*/
            ...
            if (count == 0) {
                ...
                layot.addView(iv);
              //  ((MyApplication) this.getApplication()).setCart_counter("0");
            ...
            if (c != null)
                if (c.moveToFirst()) {
                    do {
                        ...
                        SharedPreferences prefs = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
                        total_amt.setText("Amount:  \u20B9"+prefs.getInt("total_price",0));
                    ...
                    mAdapter1 = new cart_adapter(add_to_cart_dummy.this, os_versions, "database_cart","");
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            del_price.setText(obj.getString("delivery"));
                            ...
                            for(int i=0;i<product_list.length();i++)
                            {
                                ...
                                if(!"free".equals(del_price.getText().toString()))
                                {

                                    grand_total=grand_total+Integer.valueOf(del_price.getText().toString());
                                }
...
*/
                            ...
                            gridLayoutManager = new GridLayoutManager(getApplicationContext(), GridLayoutManager.VERTICAL);
                            mAdapter1 = new cart_adapter(add_to_cart_dummy.this, os_versions, "cart","");
                            mAdapter.setHasFixedSize(true);
                            // mAdapter.setLayoutManager(new StaggeredGridLayoutManager(2,1)); for tils
...
// Add the request to the queue
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
      ...
      TextView  cartcounterTV = (TextView) menu_item_cart.findViewById(R.id.cartcounter);
        ...
        if (!"0".equals(prefs.getString("cart_counter_value",null)))
            cartcounterTV.setText(prefs.getString("cart_counter_value",null));
        else
    ...
    protected void onPause() {
        ...
        add_cart(String.valueOf(jo),new CallBack() {
            ...
            public void onFail(String msg) {
                ...
                Toast.makeText(add_to_cart_dummy.this, "Invalid Login Details", Toast.LENGTH_SHORT).show();
                Log.d("jhvfff","failed");
                // Do Stuff
            }
        });
