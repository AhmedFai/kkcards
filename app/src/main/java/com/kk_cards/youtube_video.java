...
public class youtube_video extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    public void onInitializationSuccess(Provider provider, YouTubePlayer player, boolean wasRestored) {
        ...
        if (!wasRestored) {
            ...
            player.loadVideo(getIntent().getStringExtra("video_path"));
            player.play();
          //  player.cueVideo(getIntent().getStringExtra("video_path")); // Plays https://www.youtube.com/watch?v=fhWaJi1Hsfo
        }
    }
